...
static JavaVM *jni_GetJavaVM(JNIEnv *env) {
	JavaVM *vm;
...
func GetJVM(e *Env) (*JVM, error) {
	cvm := C.jni_GetJavaVM(env(e))
	if cvm == nil {
		return nil, errors.New("JNI GetJavaVM returned null")
	}
	return (*JVM)(unsafe.Pointer(cvm)), nil
}
